...
<div class="profile-container">
  <div class="profile-header">
    <h1><i class="ri-lock-password-line"></i> 修改密码</h1>
  </div>

  <div class="profile-form">
    <form action="${pageContext.request.contextPath}/profile/password/update" method="post" id="passwordForm">
      <div class="form-group">
        <label for="email"><i class="ri-mail-line"></i> 邮箱</label>
        <div class="email-verify">
          <input type="email" id="email" name="email" value="${user.email}" readonly class="readonly-input" placeholder="您的注册邮箱">
...
<script>
  ...
  sendCodeBtn.addEventListener('click', function() {
    ...
    if (!email) {
      emailFeedback.innerHTML = '<i class="ri-error-warning-line"></i> 邮箱不能为空';
